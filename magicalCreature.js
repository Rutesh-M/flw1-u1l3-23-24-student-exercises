...
let creatureName="Elf";

let creatureName2="warlock";

creatureName2=creatureName;
console.log(creatureName2)//elf
creatureName="dragon";
console.log(creatureName)//dragon
console.log(creatureName2)//dragon
// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.
let creatureDescription="it lives in the forest";
